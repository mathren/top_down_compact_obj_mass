...
the star is easier to constrain. % Various algorithms are used for the
...
an estimate of the BH mass because of the other mass loss processes that
...
only simulated helium cores. In the case of a star with a H-rich envelope still being
present at the onset of the pulsations, if it is extended and red, it
is easily removed by the first pulse \citep[][]{woosley:17,renzo:20csm} and thus the H-rich mass should be added to the
...
\cite{renzo:20conv} and the assumed nuclear reaction rates \cite{farmer:19,
